...
module.exports = {
  ...
  curve_USDC_axlUSDC_crvUSD: {
    ...
    tokenNames: ['USDBc', 'axlUSDC', 'crvUSD'],
    platform: ['Curve'],
    tags: ['Advanced', 'Stable'],
    ...
    priceFunction: {
      ...
      params: [
        ...
        addresses.BASE.V2.curve_USDC_axlUSDC_crvUSD.Underlying,
        '18',
        ['USDBc_base', 'axlUSDC', 'crvUSD_base'],
        CHAIN_IDS.BASE,
      ],
    },
    estimateApyFunctions: [
