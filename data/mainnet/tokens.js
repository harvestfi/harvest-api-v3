...
module.exports = {
  ...
  bal_MaticX: {
    chain: CHAINS_ID.MATIC_MAINNET,
    logoUrl: ['./icons/wmatic.svg', './icons/maticx.svg'],
  ...
  bal_stMatic: {
    chain: CHAINS_ID.MATIC_MAINNET,
    logoUrl: ['./icons/wmatic.svg', './icons/stmatic.svg'],
    apyIconUrls: ['./icons/balancer.png', './icons/ldo.png'],
    apyTokenSymbols: ['BAL', 'LDO'],
  ...
  bal_POLYBASE: {
    chain: CHAINS_ID.MATIC_MAINNET,
    logoUrl: ['./icons/wmatic.svg', './icons/usdc.svg', './icons/weth.svg', './icons/balancer.svg'],
    apyIconUrls: ['./icons/balancer.png'],
    apyTokenSymbols: ['BAL'],
  ...
  UniV3_zUSD_USDC_full_range: {
    ...
    apyIconUrls: [],
    apyTokenSymbols: [],
    logoUrl: ['./icons/univ3.svg', './icons/univ3-zusd-usdc.png', './icons/usdc.svg'],
  ...
  UniV3_zUSD_ETH: {
    ...
    apyIconUrls: [],
    apyTokenSymbols: [],
    logoUrl: ['./icons/univ3.svg', './icons/univ3-zusd-eth.png', './icons/eth.svg'],
    tokenNames: ['zUSD', 'ETH'],
    platform: ['Uniswap'],
  ...
  bal_USDT_WETH: {
    ...
    apyIconUrls: [],
    apyTokenSymbols: [],
    logoUrl: ['./icons/balancer.svg', './icons/usdt.svg', './icons/eth.svg'],
  ...
  bal_WBTC_WETH: {
    ...
    apyIconUrls: [],
    apyTokenSymbols: [],
    logoUrl: ['./icons/balancer.svg', './icons/btc.svg', './icons/eth.svg'],
  ...
  'SUSHI-ETH-DAI': {
    chain: CHAINS_ID.ETH_MAINNET,
    inactive: true,
    logoUrl: ['./icons/sushi.svg', './icons/dai.svg'],
    apyIconUrls: [],
    apyTokenSymbols: [],
    tokenNames: ['ETH', 'DAI'],
    platform: ['Sushi'],
  ...
  'SUSHI-ETH-USDC': {
    inactive: true,
    chain: CHAINS_ID.ETH_MAINNET,
    logoUrl: ['./icons/sushi.svg', './icons/usdc.svg'],
    apyIconUrls: [],
    apyTokenSymbols: [],
    tokenNames: ['ETH', 'USDC'],
    platform: ['Sushi'],
  ...
  'SUSHI-ETH-USDT': {
    chain: CHAINS_ID.ETH_MAINNET,
    inactive: true,
    logoUrl: ['./icons/sushi.svg', './icons/usdt.svg'],
    apyIconUrls: [],
    apyTokenSymbols: [],
    tokenNames: ['ETH', 'USDT'],
    platform: ['Sushi'],
  ...
  'SUSHI-ETH-WBTC-HODL': {
    ...
    apyTokenSymbols: [],
    subLabel: 'Hodl',
    logoUrl: ['./icons/sushi.svg', './icons/eth.svg', './icons/btc.svg'],
    tokenNames: ['ETH', 'WBTC'],
    platform: ['Sushi'],
    tokenAddress: addresses.sushi_WBTC_WETH,
    decimals: '18',
