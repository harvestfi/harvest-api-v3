...
module.exports = {
  ...
  sushi_DPX_ETH: {
    isNew: true,
    chain: CHAINS_ID.ARBITRUM_ONE,
    logoUrl: ['./icons/dpx.png', './icons/eth.svg'],
    apyIconUrls: ['./icons/sushi.svg', './icons/dpx.png'],
  ...
  sushi_RDPX_ETH: {
    isNew: true,
    chain: CHAINS_ID.ARBITRUM_ONE,
    logoUrl: ['./icons/rdpx.png', './icons/eth.svg'],
    apyIconUrls: ['./icons/sushi.svg', './icons/dpx.png'],
    apyTokenSymbols: ['SUSHI', 'DPX'],
    farmType: 'Advanced',
    platform: ['SushiSwap'],
  ...
  curve_3Crypto_polygon: {
    ...
    platform: ['Convex Finance'],
    stableCoin: false,
    tokenNames: ['amWETH', 'amWBTC', 'am3CRV'],
  ...
  curve_CRV_3Crypto_polygon: {
    ...
    apyIconUrls: ['./icons/curve.svg', './icons/cvx.svg'],
    apyTokenSymbols: ['CRV', 'CVX'],
    logoUrl: ['./icons/curve.svg', './icons/curve-tricrypto.png'],
    farmType: 'Advanced',
    platform: ['Convex Finance'],
    stableCoin: false,
  ...
  curve_MATIC_3Crypto_polygon: {
    ...
    apyIconUrls: ['./icons/curve.svg', './icons/cvx.svg'],
    apyTokenSymbols: ['CRV', 'CVX'],
    logoUrl: ['./icons/matic.svg', './icons/curve-tricrypto.png'],
    farmType: 'Advanced',
    platform: ['Convex Finance'],
    stableCoin: false,
  ...
  balancer_frxETH: {
    isNew: true,
    chain: CHAINS_ID.MATIC_MAINNET,
    logoUrl: ['./icons/frax.png', './icons/eth.svg'],
  ...
  balancer_SPHERE_MATIC: {
    isNew: true,
    chain: CHAINS_ID.MATIC_MAINNET,
    logoUrl: ['./icons/sphere.png', './icons/matic.svg'],
    apyIconUrls: ['./icons/balancer.svg'],
    apyTokenSymbols: ['BAL'],
    farmType: 'Advanced',
    platform: ['Balancer'],
  ...
  balancer_wUSDR_USDC_polygon: {
    isNew: true,
    chain: CHAINS_ID.MATIC_MAINNET,
    logoUrl: ['./icons/wusdr.png', './icons/usdc.svg'],
    apyIconUrls: ['./icons/balancer.svg'],
    apyTokenSymbols: ['BAL'],
    farmType: 'Advanced',
    platform: ['Balancer'],
  ...
  balancer_PENDLE_ETH: {
    ...
    apyIconUrls: ['./icons/balancer.svg', './icons/aura.svg'],
    apyTokenSymbols: ['BAL', 'AURA'],
    logoUrl: ['./icons/pendle.png', './icons/eth.svg'],
    farmType: 'Advanced',
    platform: ['Aura Finance'],
    stableCoin: false,
  ...
  balancer_rETH_BADGER: {
    ...
    apyIconUrls: ['./icons/balancer.svg', './icons/aura.svg'],
    apyTokenSymbols: ['BAL', 'AURA'],
    logoUrl: ['./icons/reth.svg', './icons/badger.png'],
    farmType: 'Advanced',
    platform: ['Aura Finance'],
    stableCoin: false,
  ...
  balancer_stETH_rETH_sfrxETH: {
    ...
    apyIconUrls: ['./icons/balancer.svg', './icons/aura.svg'],
    apyTokenSymbols: ['BAL', 'AURA'],
    logoUrl: ['./icons/steth.svg', './icons/reth.svg', './icons/sfrxeth.png'],
    farmType: 'Advanced',
    platform: ['Aura Finance'],
    stableCoin: false,
  ...
  curve_lvUSD: {
    isNew: true,
    chain: CHAINS_ID.ETH_MAINNET,
    logoUrl: ['./icons/lvusd.png', './icons/3crv.svg'],
    apyIconUrls: ['./icons/arch.png'],
    apyTokenSymbols: ['ARCH'],
    farmType: 'Advanced',
    platform: ['Curve'],
    stableCoin: true,
    tokenNames: ['lvUSD', '3Crv'],
  ...
  iPoison: {
    isNew: true,
    chain: CHAINS_ID.ARBITRUM_ONE,
    logoUrl: ['./icons/ipoison.png'],
    apyIconUrls: ['./icons/poison.png'],
  ...
  poison_pGOLD_USDC: {
    isNew: true,
    chain: CHAINS_ID.ARBITRUM_ONE,
    logoUrl: ['./icons/pgold.png', './icons/usdc.svg'],
    apyIconUrls: ['./icons/poison.png'],
    apyTokenSymbols: ['POISON'],
    subLabel: 'Auto-compounding',
    farmType: 'Advanced',
  ...
  poison_pSLVR_USDC: {
    isNew: true,
    chain: CHAINS_ID.ARBITRUM_ONE,
    logoUrl: ['./icons/pslvr.png', './icons/usdc.svg'],
    apyIconUrls: ['./icons/poison.png'],
    apyTokenSymbols: ['POISON'],
    subLabel: 'Auto-compounding',
    farmType: 'Advanced',
  ...
  poison_pTSLA_USDC: {
    isNew: true,
    chain: CHAINS_ID.ARBITRUM_ONE,
    logoUrl: ['./icons/ptsla.png', './icons/usdc.svg'],
    apyIconUrls: ['./icons/poison.png'],
    apyTokenSymbols: ['POISON'],
    subLabel: 'Auto-compounding',
    farmType: 'Advanced',
  ...
  lizard_SLIZ_ETH: {
    isNew: true,
    chain: CHAINS_ID.ARBITRUM_ONE,
    logoUrl: ['./icons/sliz.png', './icons/eth.svg'],
    apyIconUrls: ['./icons/sliz.png'],
    apyTokenSymbols: ['SLIZ'],
    farmType: 'Advanced',
    platform: ['SolidLizard'],
  ...
  lizard_LUSD_USDC: {
    isNew: true,
    chain: CHAINS_ID.ARBITRUM_ONE,
    logoUrl: ['./icons/lusd.png', './icons/usdc.svg'],
    apyIconUrls: ['./icons/sliz.png'],
    apyTokenSymbols: ['SLIZ'],
    farmType: 'Advanced',
    platform: ['SolidLizard'],
  ...
  aura_auraBAL_lp: {
    ...
    apyIconUrls: ['./icons/balancer.svg', './icons/aura.svg'],
    apyTokenSymbols: ['BAL', 'AURA'],
    logoUrl: ['./icons/80bal-20eth.png', './icons/aura-bal.png'],
  ...
  balancer_tetuBal: {
    chain: CHAINS_ID.MATIC_MAINNET,
    logoUrl: ['./icons/80bal-20eth.png', './icons/tetu-bal.svg'],
    apyIconUrls: ['./icons/balancer.svg'],
    apyTokenSymbols: ['BAL'],
  ...
  balancer_2BRLUSD: {
    chain: CHAINS_ID.MATIC_MAINNET,
    logoUrl: ['./icons/2brl.svg', './icons/bb-am-usd.png'],
    apyIconUrls: ['./icons/balancer.svg'],
    apyTokenSymbols: ['BAL'],
