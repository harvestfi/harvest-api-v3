...
module.exports = {
  ...
  velocore_ETH_USDCe: {
    ...
    apyIconUrls: ['./icons/vc.svg'],
    apyTokenSymbols: ['VC'],
    tokenNames: ['ETH', 'USDC.e'],
    platform: ['Velocore'],
    tags: ['Advanced'],
    tokenAddress: addresses.ZKSYNC.V2.velocore_ETH_USDCe.Underlying,
    decimals: '12',
    vaultAddress: addresses.ZKSYNC.V2.velocore_ETH_USDCe.NewVault,
    strategyAddress: addresses.ZKSYNC.V2.velocore_ETH_USDCe.NewStrategy,
    priceFunction: {
      type: GET_PRICE_TYPES.VELOCORE,
      params: [addresses.ZKSYNC.V2.velocore_ETH_USDCe.Underlying],
    },
    estimateApyFunctions: [
      {
        type: ESTIMATED_APY_TYPES.VELOCORE,
        params: [addresses.ZKSYNC.V2.velocore_ETH_USDCe.Underlying, profitSharingCut10Percent],
      },
    ],
  },
  velocore_ETH_USDT: {
    ...
    platform: ['Velocore'],
    tags: ['Advanced'],
    tokenAddress: addresses.ZKSYNC.V2.velocore_ETH_USDT.Underlying,
    decimals: '12',
    vaultAddress: addresses.ZKSYNC.V2.velocore_ETH_USDT.NewVault,
    strategyAddress: addresses.ZKSYNC.V2.velocore_ETH_USDT.NewStrategy,
    priceFunction: {
      type: GET_PRICE_TYPES.VELOCORE,
      params: [addresses.ZKSYNC.V2.velocore_ETH_USDT.Underlying],
    },
    estimateApyFunctions: [
      {
        type: ESTIMATED_APY_TYPES.VELOCORE,
        params: [addresses.ZKSYNC.V2.velocore_ETH_USDT.Underlying, profitSharingCut10Percent],
      },
    ],
  },
  velocore_VC_ETH: {
    chain: CHAIN_IDS.ZKSYNC,
    logoUrl: ['./icons/vc.svg', './icons/eth.svg'],
    apyIconUrls: ['./icons/vc.svg'],
    apyTokenSymbols: ['VC'],
    tokenNames: ['VC', 'ETH'],
    platform: ['Velocore'],
    tags: ['Advanced'],
    tokenAddress: addresses.ZKSYNC.V2.velocore_VC_ETH.Underlying,
    decimals: '18',
    vaultAddress: addresses.ZKSYNC.V2.velocore_VC_ETH.NewVault,
    strategyAddress: addresses.ZKSYNC.V2.velocore_VC_ETH.NewStrategy,
    priceFunction: {
      type: GET_PRICE_TYPES.VELOCORE,
      params: [addresses.ZKSYNC.V2.velocore_VC_ETH.Underlying],
    },
    estimateApyFunctions: [
      {
        type: ESTIMATED_APY_TYPES.VELOCORE,
        params: [addresses.ZKSYNC.V2.velocore_VC_ETH.Underlying, profitSharingCut10Percent],
      },
    ],
  },
  velocore_WBTC_ETH: {
    ...
    platform: ['Velocore'],
    tags: ['Advanced'],
    tokenAddress: addresses.ZKSYNC.V2.velocore_WBTC_ETH.Underlying,
    decimals: '13',
    vaultAddress: addresses.ZKSYNC.V2.velocore_WBTC_ETH.NewVault,
    strategyAddress: addresses.ZKSYNC.V2.velocore_WBTC_ETH.NewStrategy,
    priceFunction: {
      type: GET_PRICE_TYPES.VELOCORE,
      params: [addresses.ZKSYNC.V2.velocore_WBTC_ETH.Underlying],
    },
    estimateApyFunctions: [
      {
        type: ESTIMATED_APY_TYPES.VELOCORE,
        params: [addresses.ZKSYNC.V2.velocore_WBTC_ETH.Underlying, profitSharingCut10Percent],
      },
    ],
  },
  VC: {
    chain: CHAIN_IDS.ZKSYNC,
    logoUrl: ['./icons/vc.svg'],
    tokenAddress: addresses.ZKSYNC.VC,
    decimals: '18',
    vaultAddress: null,
    priceFunction: {
