...
module.exports = {
  ...
  aerodrome_DAIp_USDp: {
    ...
    logoUrl: ['./icons/daiplus.svg', './icons/usdcplus.svg'],
    tokenNames: ['DAI+', 'USD+'],
    platform: ['Aerodrome'],
  ...
  aerodrome_USDp_USDC: {
    ...
    priceFunction: {
      type: GET_PRICE_TYPES.LP_TOKEN,
      params: [addresses.BASE.V2.aerodrome_USDp_USDC.Underlying, 'USD+_base', 'USDC_base'],
    },
    estimateApyFunctions: [
      {
        type: ESTIMATED_APY_TYPES.AERODROME,
  ...
  curve_USDC_axlUSDC_crvUSD: {
    inactive: true,
    chain: CHAIN_IDS.BASE,
    apyIconUrls: ['./icons/curve.svg'],
    apyTokenSymbols: ['CRV'],
    logoUrl: ['./icons/usdc.svg', './icons/axlusdc.svg', './icons/crvusd.svg'],
    tokenNames: ['USDC', 'axlUSDC', 'crvUSD'],
    platform: ['Curve'],
    tags: ['Advanced', 'Stable'],
    tokenAddress: addresses.BASE.V2.curve_USDC_axlUSDC_crvUSD.Underlying,
    decimals: '18',
    vaultAddress: addresses.BASE.V2.curve_USDC_axlUSDC_crvUSD.NewVault,
    priceFunction: {
      type: GET_PRICE_TYPES.CURVE_POOL,
      params: [
        addresses.BASE.V2.curve_USDC_axlUSDC_crvUSD.Underlying,
        addresses.BASE.V2.curve_USDC_axlUSDC_crvUSD.Underlying,
        '18',
        ['USDC_base', 'axlUSDC', 'crvUSD_base'],
        CHAIN_IDS.BASE,
      ],
    },
    estimateApyFunctions: [
      {
        ...
        params: [
          'curve_USDC_axlUSDC_crvUSD',
          addresses.BASE.V2.curve_USDC_axlUSDC_crvUSD.Gauge,
          profitSharingCut10Percent,
          CHAIN_IDS.BASE,
        ],
      },
  ...
  curve_USDC_USDBc_axlUSDC_crvUSD: {
    ...
    priceFunction: {
      ...
      params: [
        ...
        addresses.BASE.V2.curve_USDC_USDBc_axlUSDC_crvUSD.Underlying,
        '18',
        ['USDC_base', 'USDC_base_bridged', 'axlUSDC', 'crvUSD_base'],
        CHAIN_IDS.BASE,
      ],
    },
    estimateApyFunctions: [
  ...
  curve_CRV_crvUSD: {
    ...
    apyIconUrls: ['./icons/curve.svg'],
    apyTokenSymbols: ['CRV'],
    logoUrl: ['./icons/crv.svg', './icons/crvusd.svg'],
  ...
  camelot_UWU_USDC: {
    ...
    apyTokenSymbols: ['GRAIL', 'XGRAIL', 'USDC', 'UWU'],
    tokenNames: ['UWU', 'USDC'],
    platform: ['Camelot'],
    tags: ['Advanced'],
    ...
    cmcRewardTokenSymbols: ['iFARM', 'GRAIL', 'XGRAIL', 'USDC', 'UWU'],
  },
  AERO: {
    chain: CHAIN_IDS.BASE,
  ...
  aerodrome_AERO_USDC: {
    ...
    priceFunction: {
      type: GET_PRICE_TYPES.LP_TOKEN,
      params: [addresses.BASE.V2.aerodrome_AERO_USDC.Underlying, 'AERO', 'USDC_base'],
    },
    estimateApyFunctions: [
      {
        type: ESTIMATED_APY_TYPES.AERODROME,
  ...
  aerodrome_ETH_USDC: {
    ...
    priceFunction: {
      type: GET_PRICE_TYPES.LP_TOKEN,
      params: [addresses.BASE.V2.aerodrome_ETH_USDC.Underlying, 'USDC_base', 'WETH_base'],
    },
    estimateApyFunctions: [
      {
        type: ESTIMATED_APY_TYPES.AERODROME,
  ...
  aerodrome_fBOMB_ETH: {
    ...
    apyIconUrls: ['./icons/aero.svg'],
    apyTokenSymbols: ['AERO'],
    logoUrl: ['./icons/fbomb.svg', './icons/eth.svg'],
    tokenNames: ['fBOMB', 'ETH'],
    platform: ['Aerodrome'],
    tags: ['Advanced'],
    tokenAddress: addresses.BASE.V2.aerodrome_fBOMB_ETH.Underlying,
    decimals: '18',
    vaultAddress: addresses.BASE.V2.aerodrome_fBOMB_ETH.NewVault,
    priceFunction: {
      type: GET_PRICE_TYPES.LP_TOKEN,
      params: [addresses.BASE.V2.aerodrome_fBOMB_ETH.Underlying, 'fBOMB_base', 'WETH_base'],
    },
    estimateApyFunctions: [
      {
        type: ESTIMATED_APY_TYPES.AERODROME,
        params: [
          addresses.BASE.V2.aerodrome_fBOMB_ETH.Underlying,
          addresses.BASE.V2.aerodrome_fBOMB_ETH.Gauge,
          profitSharingCut10Percent,
        ],
      },
    ],
  ...
  aerodrome_tBTC_USDC: {
    ...
    priceFunction: {
      type: GET_PRICE_TYPES.LP_TOKEN,
      params: [addresses.BASE.V2.aerodrome_tBTC_USDC.Underlying, 'tBTC_base', 'USDC_base'],
    },
    estimateApyFunctions: [
      {
        type: ESTIMATED_APY_TYPES.AERODROME,
  ...
  aerodrome_wUSDR_USDC: {
    ...
    priceFunction: {
      type: GET_PRICE_TYPES.LP_TOKEN,
      params: [addresses.BASE.V2.aerodrome_wUSDR_USDC.Underlying, 'wUSDR_base', 'USDC_base'],
    },
    estimateApyFunctions: [
      {
        type: ESTIMATED_APY_TYPES.AERODROME,
  ...
  baseswap_DAI_USDC: {
    ...
    priceFunction: {
      type: GET_PRICE_TYPES.LP_TOKEN,
      params: [addresses.BASE.V2.baseswap_DAI_USDC.Underlying, 'DAI_base', 'USDC_base'],
    },
    estimateApyFunctions: [
      {
        type: ESTIMATED_APY_TYPES.BASESWAP_V2,
  ...
  baseswap_ETH_USDC: {
    ...
    priceFunction: {
      type: GET_PRICE_TYPES.LP_TOKEN,
      params: [addresses.BASE.V2.baseswap_ETH_USDC.Underlying, 'WETH_base', 'USDC_base'],
    },
    estimateApyFunctions: [
      {
        type: ESTIMATED_APY_TYPES.BASESWAP_V2,
