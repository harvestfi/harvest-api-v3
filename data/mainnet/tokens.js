...
module.exports = {
  ...
  curve_ETHp_WETH: {
    ...
    tags: ['Advanced'],
    tokenAddress: addresses.ARBITRUM_ONE.V2.curve_ETHp_WETH.Underlying,
    decimals: '18',
    vaultAddress: addresses.ARBITRUM_ONE.V2.curve_ETHp_WETH.NewVault,
    strategyAddress: addresses.ARBITRUM_ONE.V2.curve_ETHp_WETH.NewStrategy,
    priceFunction: {
      type: GET_PRICE_TYPES.CURVE_POOL,
      params: [
        addresses.ARBITRUM_ONE.V2.curve_ETHp_WETH.Underlying,
        addresses.ARBITRUM_ONE.V2.curve_ETHp_WETH.Underlying,
        '18',
    ...
    estimateApyFunctions: [
      {
        ...
        params: [
          'curve_ETHp_WETH',
          addresses.ARBITRUM_ONE.V2.curve_ETHp_WETH.Gauge,
          profitSharingCut10Percent,
          CHAIN_IDS.ARBITRUM_ONE,
          addresses.ARBITRUM_ONE.V2.curve_ETHp_WETH.NewStrategy,
        ],
      },
    ],
  },
    ...
    estimateApyFunctions: [
      {
        ...
        params: [
          'curve_eUSD_USDC',
          addresses.ARBITRUM_ONE.V2.curve_eUSD_USDC.Gauge,
          profitSharingCut10Percent,
          CHAIN_IDS.ARBITRUM_ONE,
          addresses.ARBITRUM_ONE.V2.curve_eUSD_USDC.NewStrategy,
        ],
      },
    ],
  },
    ...
    estimateApyFunctions: [
      {
        ...
        params: [
          'curve_KNOX_eUSD',
          addresses.ARBITRUM_ONE.V2.curve_KNOX_eUSD.Gauge,
          profitSharingCut10Percent,
          CHAIN_IDS.ARBITRUM_ONE,
          addresses.ARBITRUM_ONE.V2.curve_KNOX_eUSD.NewStrategy,
        ],
      },
    ],
  },
  curve_OVN_stable: {
    chain: CHAIN_IDS.ARBITRUM_ONE,
    apyIconUrls: ['./icons/ovn.svg'],
    apyTokenSymbols: ['OVN'],
    logoUrl: ['./icons/usdp.svg', './icons/usdtp.svg'],
    tokenNames: ['USD+', 'USDT+'],
    platform: ['Curve', 'Overnight'],
    tags: ['Advanced', 'Stable'],
    ...
    estimateApyFunctions: [
      {
        ...
        params: [
          'curve_OVN_stable',
          addresses.ARBITRUM_ONE.V2.curve_OVN_stable.Gauge,
          profitSharingCut10Percent,
          CHAIN_IDS.ARBITRUM_ONE,
          addresses.ARBITRUM_ONE.V2.curve_OVN_stable.NewStrategy,
        ],
      },
    ],
  },
  curve_OVN: {
    chain: CHAIN_IDS.ARBITRUM_ONE,
    apyIconUrls: ['./icons/crv.svg', './icons/ovn.svg', './icons/arb.svg'],
    apyTokenSymbols: ['CRV', 'OVN', 'ARB'],
    logoUrl: ['./icons/usdp.svg', './icons/frax.svg', './icons/usdc.svg'],
    ...
    estimateApyFunctions: [
      {
        ...
        params: [
          'curve_OVN',
          addresses.ARBITRUM_ONE.V2.curve_OVN.Gauge,
          profitSharingCut10Percent,
          CHAIN_IDS.ARBITRUM_ONE,
          addresses.ARBITRUM_ONE.V2.curve_OVN.NewStrategy,
        ],
      },
    ],
  },
  curve_TriCRV_ARB: {
    ...
    apyTokenSymbols: ['ARB'],
    logoUrl: ['./icons/crvusd.svg', './icons/arb.svg', './icons/crv.svg'],
    ...
    estimateApyFunctions: [
      {
        ...
        params: [
          'curve_WBTC_tBTC',
          addresses.ARBITRUM_ONE.V2.curve_WBTC_tBTC.Gauge,
          profitSharingCut10Percent,
          CHAIN_IDS.ARBITRUM_ONE,
          addresses.ARBITRUM_ONE.V2.curve_WBTC_tBTC.NewStrategy,
        ],
      },
    ],
  },
