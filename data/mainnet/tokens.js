...
module.exports = {
  ...
  curve_WBTC_cbBTC_hemiBTC: {
    ...
    apyIconUrls: ['./icons/curve.svg'],
    apyTokenSymbols: ['CRV'],
    logoUrl: ['./icons/wbtc.svg', './icons/cbbtc.svg', './icons/hemicbtc.svg'],
  ...
  morpho_KPKP_ETH: {
    ...
    logoUrl: ['./icons/eth.svg'],
    tokenNames: ['ETH'],
    platform: ['Morpho - kpk ETH Prime V2'],
    tags: ['Beginner'],
  ...
  morpho_KPKP_USDC: {
    ...
    tokenNames: ['USDC'],
    platform: ['Morpho - kpk USDC Prime V2'],
  ...
  morpho_KPKY_ETH: {
    ...
    logoUrl: ['./icons/eth.svg'],
    tokenNames: ['ETH'],
    platform: ['Morpho - kpk ETH Yield V2'],
    tags: ['Beginner'],
  ...
  morpho_KPKY_USDC: {
    ...
    logoUrl: ['./icons/usdc.svg'],
    tokenNames: ['USDC'],
    platform: ['Morpho - kpk USDC Yield V2'],
    tags: ['Beginner', 'Stable'],
  ...
  ConvexLend_crvUSD_CRV: {
    ...
    tags: ['Advanced', 'Stable'],
    tokenAddress: addresses.V2.ConvexLend_crvUSD_CRV.Underlying,
    decimals: '18',
    vaultAddress: addresses.V2.ConvexLend_crvUSD_CRV.NewVault,
    strategyAddress: addresses.V2.ConvexLend_crvUSD_CRV.NewStrategy,
    priceFunction: { type: GET_PRICE_TYPES.COINGECKO_ID, params: ['crvusd'] },
    estimateApyFunctions: [
      {
        type: ESTIMATED_APY_TYPES.CONVEX_LEND,
        params: [addresses.V2.ConvexLend_crvUSD_CRV.PoolId, profitSharingCut15Percent],
      },
    ],
  },
  ConvexLend_crvUSD_sfrxUSD: {
    chain: CHAIN_IDS.ETH_MAINNET,
    apyIconUrls: ['./icons/curve.svg', './icons/cvx.svg'],
    apyTokenSymbols: ['CRV', 'CVX'],
    logoUrl: ['./icons/crvusd.svg'],
    tokenNames: ['crvUSD'],
    platform: ['Convex Finance - Llamalend - sfrxUSD'],
    tags: ['Advanced', 'Stable'],
    tokenAddress: addresses.V2.ConvexLend_crvUSD_sfrxUSD.Underlying,
    decimals: '18',
    vaultAddress: addresses.V2.ConvexLend_crvUSD_sfrxUSD.NewVault,
    strategyAddress: addresses.V2.ConvexLend_crvUSD_sfrxUSD.NewStrategy,
    priceFunction: { type: GET_PRICE_TYPES.COINGECKO_ID, params: ['crvusd'] },
    estimateApyFunctions: [
      {
        type: ESTIMATED_APY_TYPES.CONVEX_LEND,
        params: [addresses.V2.ConvexLend_crvUSD_sfrxUSD.PoolId, profitSharingCut15Percent],
      },
    ],
  },
  ConvexLend_crvUSD_sUSDS: {
    chain: CHAIN_IDS.ETH_MAINNET,
    apyIconUrls: ['./icons/curve.svg', './icons/cvx.svg'],
    apyTokenSymbols: ['CRV', 'CVX'],
    logoUrl: ['./icons/crvusd.svg'],
    ...
    tags: ['Advanced', 'Stable'],
    tokenAddress: addresses.V2.ConvexLend_crvUSD_sUSDS.Underlying,
    decimals: '18',
    vaultAddress: addresses.V2.ConvexLend_crvUSD_sUSDS.NewVault,
    strategyAddress: addresses.V2.ConvexLend_crvUSD_sUSDS.NewStrategy,
    priceFunction: { type: GET_PRICE_TYPES.COINGECKO_ID, params: ['crvusd'] },
    estimateApyFunctions: [
      {
        type: ESTIMATED_APY_TYPES.CONVEX_LEND,
        params: [addresses.V2.ConvexLend_crvUSD_sUSDS.PoolId, profitSharingCut15Percent],
      },
    ],
  },
  ConvexLend_crvUSD_tBTC: {
    chain: CHAIN_IDS.ETH_MAINNET,
    apyIconUrls: ['./icons/curve.svg', './icons/cvx.svg'],
    apyTokenSymbols: ['CRV', 'CVX'],
    logoUrl: ['./icons/crvusd.svg'],
    tokenNames: ['crvUSD'],
    platform: ['Convex Finance - Llamalend - tBTC'],
    tags: ['Advanced', 'Stable'],
    tokenAddress: addresses.V2.ConvexLend_crvUSD_tBTC.Underlying,
    decimals: '18',
    vaultAddress: addresses.V2.ConvexLend_crvUSD_tBTC.NewVault,
    strategyAddress: addresses.V2.ConvexLend_crvUSD_tBTC.NewStrategy,
    priceFunction: { type: GET_PRICE_TYPES.COINGECKO_ID, params: ['crvusd'] },
    estimateApyFunctions: [
      {
        type: ESTIMATED_APY_TYPES.CONVEX_LEND,
        params: [addresses.V2.ConvexLend_crvUSD_tBTC.PoolId, profitSharingCut15Percent],
      },
    ],
  },
  ConvexLend_crvUSD_WBTC: {
    inactive: true,
    chain: CHAIN_IDS.ETH_MAINNET,
    apyIconUrls: ['./icons/curve.svg', './icons/cvx.svg'],
    apyTokenSymbols: ['CRV', 'CVX'],
    ...
    tags: ['Advanced', 'Stable'],
    tokenAddress: addresses.V2.ConvexLend_crvUSD_WBTC.Underlying,
    decimals: '18',
    vaultAddress: addresses.V2.ConvexLend_crvUSD_WBTC.NewVault,
    strategyAddress: addresses.V2.ConvexLend_crvUSD_WBTC.NewStrategy,
    priceFunction: { type: GET_PRICE_TYPES.COINGECKO_ID, params: ['crvusd'] },
    estimateApyFunctions: [
      {
        type: ESTIMATED_APY_TYPES.CONVEX_LEND,
        params: [addresses.V2.ConvexLend_crvUSD_WBTC.PoolId, profitSharingCut15Percent],
      },
    ],
  },
  dolomite_USD1: {
  ...
  moonwellLoop_wstETH_ETH: {
    ...
    platform: ['Moonwell - Looping'],
    tags: ['Beginners', 'LSD'],
    tokenAddress: addresses.BASE.V2.moonwellLoop_wstETH_ETH.Underlying,
    decimals: '18',
    vaultAddress: addresses.BASE.V2.moonwellLoop_wstETH_ETH.NewVault,
    strategyAddress: addresses.BASE.V2.moonwellLoop_wstETH_ETH.NewStrategy,
    priceFunction: {
      type: GET_PRICE_TYPES.COINGECKO_ID,
    ...
    estimateApyFunctions: [
      {
        type: ESTIMATED_APY_TYPES.MOONWELL_FOLD_2ASSET,
        params: [
          addresses.BASE.V2.moonwellLoop_wstETH_ETH.Underlying,
          addresses.BASE.V2.moonwellLoop_wstETH_ETH.supplymToken,
          addresses.BASE.V2.moonwellLoop_wstETH_ETH.borrowmToken,
          addresses.BASE.V2.moonwellLoop_wstETH_ETH.NewStrategy,
          profitSharingCut10Percent,
        ],
      },
    ],
  ...
  moonwellLoop_cbETH_ETH: {
    ...
    platform: ['Moonwell - Looping'],
    tags: ['Beginners', 'LSD'],
    tokenAddress: addresses.BASE.V2.moonwellLoop_cbETH_ETH.Underlying,
    decimals: '18',
    vaultAddress: addresses.BASE.V2.moonwellLoop_cbETH_ETH.NewVault,
    strategyAddress: addresses.BASE.V2.moonwellLoop_cbETH_ETH.NewStrategy,
    priceFunction: {
      type: GET_PRICE_TYPES.COINGECKO_ID,
    ...
    estimateApyFunctions: [
      {
        type: ESTIMATED_APY_TYPES.MOONWELL_FOLD_2ASSET,
        params: [
          addresses.BASE.V2.moonwellLoop_cbETH_ETH.Underlying,
          addresses.BASE.V2.moonwellLoop_cbETH_ETH.supplymToken,
          addresses.BASE.V2.moonwellLoop_cbETH_ETH.borrowmToken,
          addresses.BASE.V2.moonwellLoop_cbETH_ETH.NewStrategy,
          profitSharingCut10Percent,
        ],
      },
    ],
