...
const ESTIMATED_APY_TYPES = {
  ...
  SYNCSWAP: 'SYNCSWAP',
  MAKER_SDAI: 'MAKER_SDAI',
  AAVE_FOLD: 'AAVE_FOLD',
  MORPHO_VAULT: 'MORPHO_VAULT',
  IPOR: 'IPOR',
  IPOR_LENDING: 'IPOR_LENDING',
  CAMELOT_MERKL: 'CAMELOT_MERKL',
  VENUS_FOLD: 'VENUS_FOLD',
  DRIP: 'DRIP',
  EULER_VAULT: 'EULER_VAULT',
  ARCADIA_LEND: 'ARCADIA_LEND',
  FORTY_ACRES: 'FORTY_ACRES',
  PROFIT_SHARE: 'PROFIT_SHARE',
  SILO: 'SILO',
  EULER_EARN: 'EULER_EARN',
  SILO_VAULT: 'SILO_VAULT',
  HYPURR: 'HYPURR',
  MORPHO_MARKET: 'MORPHO_MARKET',
  MOONWELL_FOLD_2ASSET: 'MOONWELL_FOLD_2ASSET',
  STAKE_DAO: 'STAKE_DAO',
  AAVE_FOLD_2ASSET: 'AAVE_FOLD_2ASSET',
  CL_VAULT: 'CL_VAULT',
}
