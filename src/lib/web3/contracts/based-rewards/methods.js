...
const getRewardRate = (epoch, instance) => countFunctionCall(instance.methods.epochBasedPerSecond(epoch).call())
...
const getEpochFinishTime = (epoch, instance) => countFunctionCall(instance.methods.epochEndTimes(epoch).call())
